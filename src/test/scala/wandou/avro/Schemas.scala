...
object Schemas {
  ...
  val actionRecord = union.getTypes.get(union.getIndexNamed("wandou.avro.test.ActionRecord"))
  val actionInfo = union.getTypes.get(union.getIndexNamed("wandou.avro.test.ActionInfo"))

  val appInfo = union.getTypes.get(union.getIndexNamed("wandou.avro.test.AppInfo"))

  val loginRecord = union.getTypes.get(union.getIndexNamed("wandou.avro.test.LoginRecord"))
  val chargeRecord = union.getTypes.get(union.getIndexNamed("wandou.avro.test.ChargeRecord"))

  val account = union.getTypes.get(union.getIndexNamed("wandou.avro.test.Account"))
